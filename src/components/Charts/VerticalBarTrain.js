...
const VerticalBarTrain = () => {
    ...
    datasets: [
      {
        label: "# of Votes",
        data: [
          dataTrain.qtd_violencia_sexual,
          dataTrain.qtd_violencia_fisica,
          dataTrain.qtd_violencia_moral,
          dataTrain.qtd_violencia_social,
        ],
        backgroundColor: [
          "rgba(255, 99, 132, 0.2)",
          "rgba(54, 162, 235, 0.2)",
  ...
  return (
    <>
      <div>
        <Description>Informações sobre Trem</Description>
      </div>
